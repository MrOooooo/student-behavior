...
def behavior_panel() -> rx.Component:
    ...
    return rx.el.div(
        rx.el.h3("Behavior Analysis", class_name="text-lg font-semibold mb-2 text-cyan-50"),
        rx.el.div(
            rx.el.div(
                rx.el.span("Behavior: ", class_name="text-cyan-100"),
                rx.el.span(
            ...
            rx.el.div(
                rx.el.span("Confidence Level: ", class_name="text-cyan-100"),
                rx.el.span(
