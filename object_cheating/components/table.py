...
def create_data_row(data: Dict[str, str]):
    return rx.table.row(
        rx.table.cell(rx.text(data["no"], color="#dffbff", font_size="11px", weight="medium")),
        rx.table.cell(rx.text(data["location_file"], color="#dffbff", font_size="11px", weight="medium")),
        rx.table.cell(
            rx.badge(
                data["behaviour"],
        ...
        rx.table.cell(rx.text(data["coordinate"], color="#dffbff", font_size="11px", weight="regular")),
        align="center",
        white_space="nowrap",
    )
                ...
                rx.table.header(
                    rx.table.row(
                        rx.foreach(
                            ...
                            lambda title: rx.table.column_header_cell(rx.text(title, font_size="12px", weight="bold", color="#dffbff")),
                        ),
                    ),
                    position="sticky",
                    top="0",
