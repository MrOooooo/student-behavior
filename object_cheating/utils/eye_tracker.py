            ...
            if detection_result.face_landmarks:
                ...
                if (left_conf > cnn_threshold and left_direction != "closed") or \
                   (right_conf > cnn_threshold and right_direction != "closed"):
                    ...
                    target_matched = (
                        self._target_selected(left_direction, active_targets) and left_conf > cnn_threshold
                    ) or (
                        self._target_selected(right_direction, active_targets) and right_conf > cnn_threshold
                    )
